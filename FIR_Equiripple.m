...
filter1 = low_band_Equiripple(Fs);
filter2 = band_pass_Equiripple(170,310,Fs);
filter3 = band_pass_Equiripple(310,600,Fs);
filter4 = band_pass_Equiripple(600,1000,Fs);
filter5 = band_pass_Equiripple(1000,3000,Fs);
filter6 = band_pass_Equiripple(3000,6000,Fs);
filter7 = band_pass_Equiripple(6000,12000,Fs);
filter8 = band_pass_Equiripple(12000,14000,Fs);
filter9 = band_pass_Equiripple(14000,16000,Fs);
